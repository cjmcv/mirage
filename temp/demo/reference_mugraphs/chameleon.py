...
if __name__ == "__main__":
    ...
    tbgraph1 = mi.new_threadblock_graph(grid_dim=(8,16,4), block_dim=(128,1,1), thread_num=4, reduction_dimx=64)
    ...
    tbgraph2 = mi.new_threadblock_graph(grid_dim=(8,16,1), block_dim=(128,1,1), thread_num=1, reduction_dimx=64)
