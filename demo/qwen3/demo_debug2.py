...
if __name__ == "__main__":
    ...
    x_torch = torch.ones((8, 4096), dtype=torch.bfloat16, device="cuda")
    w_qkv_torch = torch.ones((6144, 4096), dtype=torch.bfloat16, device="cuda")
    attn_in_torch = torch.zeros((8, 6144), dtype=torch.bfloat16, device="cuda")
